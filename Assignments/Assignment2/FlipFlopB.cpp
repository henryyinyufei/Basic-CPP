...
bool PlacePiece(int **FlipFlopBoard,
	int numRowsInBoard, int player, int squarePlayed,
	int whichPiece, int& numberCaptured);
bool DisplayBoard(int **FlipFlopBoard,
	int numRowsInBoard);
bool InitialiizeBoard(int **FlipFlopBoard,
	int numRowsInBoard);
bool CheckLine(int **FlipFlopBoard,
	int numRowsInBoard, int player, int squarePlayed,
	int xDirection, int yDirection, int& numCaptured);
bool IsAnyMoveValid(int **FlipFlopBoard,
	int numRowsInBoard, int player, int whichPiece);
bool IsThisMoveValid(int **FlipFlopBoard,
...
int main()
{
	...
	myFlipFlopBoard = new (nothrow) int*[numRowsInBoard];
	myFlipFlopBoard[0] = new (nothrow) int[numRowsInBoard*numRowsInBoard];
	...
	delete[] myFlipFlopBoard[0];
	delete[] myFlipFlopBoard;

	return 0;
}


bool CheckLine(int **FlipFlopBoard, int numRowsInBoard,
...
bool InitialiizeBoard(int **FlipFlopBoard, int numRowsInBoard)
{
	...
	if (FlipFlopBoard[0] == NULL)
	{
		return false;
	}

	// empty board
	for (int k = 1; k < numRowsInBoard; k++)
	{
		FlipFlopBoard[k] = FlipFlopBoard[0] + k * numRowsInBoard;
	}
...
bool DisplayBoard(int **FlipFlopBoard, int numRowsInBoard)
{
...
bool IsAnyMoveValid(int **FlipFlopBoard, int numRowsInBoard, int player, int whichPiece)
{
	int squarePlayed = 0;
...
bool IsThisMoveValid(int **FlipFlopBoard, int numRowsInBoard, int player, int squarePlayed, int whichPiece)
{
	int row = 0;
	int col = 0;
	int numberCaptured = 0;
...
// PlacePiece() function
bool PlacePiece(int **FlipFlopBoard, int numRowsInBoard,
